...
my_theme <- theme_bw() +
  theme(panel.grid.major = element_line(colour = "deeppink4", linetype = "dotted"), 
                  ...
                  axis.title = element_text(face = "bold", colour = "deeppink2", size = 20), 
                  axis.text = element_text(size = 15, face = "bold", colour = "deeppink2"), 
                  plot.title = element_text(size = 20, face = "bold", colour = "deeppink2"), 
