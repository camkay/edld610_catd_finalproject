...
Finally, to increase interpretability, I added a `geom_label`, inset in the plot, describing the number of kilometers that an AU represents, and a legend describing what color of planets come from the Solar System universe and what color of planets come from the Star Wars universe. 
